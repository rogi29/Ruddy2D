...
/**
 * Matrix is a 3x2 affine matrix implementation. The constructor accepts another Matrix or a list of six float elements.
 * If no parameters are provided the matrix is set to the identity matrix.
 *
 * @param {Matrix} matrix  the initial matrix to set to
...
var Matrix = function() {
    if (arguments.length === 0) {
        this.reset();
    } else if (arguments.length === 1 && arguments[0] instanceof Matrix) {
...
Matrix.prototype = {
    /**
     * @member Matrix
     * The set() function sets the matrix elements. The function accepts either another Matrix, an array of elements, or a list of six floats.
     *
     * @param {Matrix} matrix    the matrix to set this matrix to
    ...
    /**
     * @member Matrix
     * The get() function returns a copy of this Matrix.
     *
     * @return {Matrix} a copy of this Matrix
     */
    get: function() {
        var outgoing = new Matrix();
        outgoing.set(this.elements);
        return outgoing;
    },
    /**
     * @member Matrix
     * The reset() function sets this Matrix to the identity matrix.
     */
    reset: function() {
    ...
    /**
     * @member Matrix
     * The apply() function multiplies the current matrix by the one specified through the parameters. Note that either a Matrix or a list of floats can be passed in.
     *
     * @param {Matrix} matrix    the matrix to apply this matrix to
     * @param {float} m00           the first element of the matrix
     * @param {float} m01           the third element of the matrix
     * @param {float} m10           the fourth element of the matrix
     * @param {float} m11           the fith element of the matrix
    ...
    /**
     * @member Matrix
     * The preApply() function applies another matrix to the left of this one. Note that either a Matrix or elements of a matrix can be passed in.
     *
     * @param {Matrix} matrix    the matrix to apply this matrix to
     * @param {float} m00           the first element of the matrix
     * @param {float} m01           the third element of the matrix
